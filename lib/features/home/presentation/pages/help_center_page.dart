...
class _HelpCenterStaticContent extends StatefulWidget {
  const _HelpCenterStaticContent();

  @override
  State<_HelpCenterStaticContent> createState() => _HelpCenterStaticContentState();
}

class _HelpCenterStaticContentState extends State<_HelpCenterStaticContent> {
